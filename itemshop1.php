...
echo "<li><a href='itemshop.php?ctg=$ctg[0]&search=$_GET[search]'>$ctg[1]</a></li>";
}
?>
</ul>
</div>
  ...
  <div class="rigth_container">
    ...
    <div class="new2_item_container">
      <div class="right_top">Premium Items</div>
...
if ($_GET[search]!=NULL)
{
	$sea = "&#155&#155 Search : $_GET[search] (<a href = 'itemshop.php?ctg=$_GET[ctg]&search='>Clear Search</a>)";
}
if ($_GET[section]==1)
{
...
echo "<a href='itemshop.php?section=&ctg=&search='><w_10_unb>$sec</w_10_unb></a> <w_10_unb>$ctg</w_10_unb> <red_10_unb>$sea</red_10_unb>";
?>
...
echo "<option value='itemshop.php?Page=$i'>$i</option>";
