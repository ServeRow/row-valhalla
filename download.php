...
<title><?=$dfconfig['web_title'];?> - Game Download</title>
...
<div class="news_container">
                <div class="right_top">Downloads</div>
                    <div class="right_center_colum">
<?                     
$get_dl = mssql_query("SELECT * FROM download order by date desc");
while ($dl = mssql_fetch_array($get_dl)) { 
?>
		<div class="dl_box">
            <div class="news_detail"><?=$dl[1]?></div>
                <div class="clear"></div>
            <div class="news_view">
                    <?
                    $txt = base64_decode($dl[text]);
