...
<title><?=$dfconfig['web_title'];?> - Reborn Shop</title>
...
<div class="container">
  ...
  <div class="left_container">
 	 <div class="left_bg">
			...
			<div class="cw_body">
                  <form action="rb-shop.php.php?" >
                    <input name="username" type="text" class="search_input" value="Search..." /><input name="" type="submit" class="search_btn" value="Search"  />
                      </form>
              <div class="clear"></div>
			  </div>
          </div>
...
echo "<li><a href='rb-shop.php.php?ctg=$ctg[0]&search=$_GET[search]'>$ctg[1]</a></li>";
}
?>
</ul>
</div>
  ...
  <div class="rigth_container">
    ...
    <div class="new2_item_container">
      <div class="right_top">Reborn Items</div>
...
if ($_GET[search]!=NULL)
{
	$sea = "&#155&#155 Search : $_GET[search] (<a href = 'rb-shop.php.php?ctg=$_GET[ctg]&search='>Clear Search</a>)";
}
if ($_GET[section]==1)
{
...
echo "<a href='rb-shop.php.php?section=&ctg=&search='><w_10_unb>$sec</w_10_unb></a> <w_10_unb>$ctg</w_10_unb> <red_10_unb>$sea</red_10_unb>";
?>
...
$itemsql = "SELECT * FROM $dfsql[db3].dbo.ShopItemMap where ItemSec = '$_GET[section]' $ctg $search order by date desc";
$shopsql = "$itemsql";
...
{
$id=mssql_result($shopsqlQuery,$i,"ProductNum");
$get_new_item = mssql_query("SELECT  * FROM $dfsql[db3].dbo.ShopItemMap where ProductNum = '$id'");
...
echo "<option value='rb-shop.php.php?Page=$i'>$i</option>";
